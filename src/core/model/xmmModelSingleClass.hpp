...
namespace xmm
{
    ...
    public:
        ...
        enum class ErrorType {
            /**
             ...
             @details these errors can be due to issues with the training data (e.g. nan values), or
        ...
        /**
         @brief Log-likelihood of the data given the model's parameters at the en of training
         */
    ...
    public:
        ...
        /**
         ...
         @param src Source Model
         */
        SingleClassProbabilisticModel& operator=(SingleClassProbabilisticModel const& src);
        ...
        /**
         ...
         @details the method performs a loop over the pure virtual method emAlgorithmUpdate() until convergence.
         The @a emAlgorithmUpdate method computes both E and M steps of the EM algorithm.
        ...
        /**
         @brief Cancels the training process : sets a flag so that the training stops at the next
         possible exit in the training process.
         @warning the model is still training when this function returns. This function only requests the training
         process to cancel.
         */
        void cancelTraining();
    ...
    protected:
        ...
        /**
         @brief Event containing information on the current status of the training process
         */
        TrainingEvent training_status_;
