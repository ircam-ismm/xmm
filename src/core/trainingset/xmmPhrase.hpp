...
namespace xmm
{
    ...
    public:
        ...
        /**
         @brief Destructor.
         @details Data is only deleted if the memory is owned (construction with MemoryMode::OwnMemory)
         */
        virtual ~Phrase();
        ...
        /**
         ...
         @param index time index
         @warning  this method can be used only for unimodal phrases (construction with Multimodality::Unimodal)
         @throws out_of_range if time index is out of bounds
         @throws runtime_error if the phrase is bimodal (construction with Multimodality::Bimodal)
        ...
        /**
         ...
         @warning  this method can be used only for bimodal phrases (construction with Multimodality::Bimodal)
         @param index time index
         @throws out_of_range if time index is out of bounds
         @throws runtime_error if the phrase is unimodal (construction with Multimodality::Unimodal)
         @return pointer to the data array of the modality, for the given time index
         */
        ...
        /**
         ...
         @warning This method is only usable in Shared Memory (construction with MemoryMode::SharedMemory)
         @param pointer_to_data pointer to the data array
         @param length length of the data array
         @throws runtime_error if data is owned (construction with MemoryMode::OwnMemory flag)
         */
        ...
        /**
         ...
         @throws runtime_error if data is owned (construction with MemoryMode::OwnMemory flag)
         */
        void connect(float *pointer_to_data_input, float *pointer_to_data_output, std::size_t length);
        ...
        /**
         ...
         @throws runtime_error if data is shared (construction with MemoryMode::SharedMemory flag)
         */
