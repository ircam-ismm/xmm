...
namespace xmm
{
    ...
    enum class MultiClassRegressionEstimator
    {
        ...
        /**
         @brief the output is estimated as a weight sum of the output values of each class
         */
        Mixture = 1
    };
    ...
    enum class MultithreadingMode
    {
        ...
        /**
         @brief Multithreading: all classes are trained in parallel in different threads. the train
         function returns after all classes have finished training.
         */
        Parallel,
        
        /**
         @brief Multithreading in Background: all classes are trained in parallel in different threads. the train
         function returns after the training has started
         @warning when the train function return, models are still training in background.
         */
        Background
    };
    ...
    /**
     ...
     @details The object contains both default parameters and class-specific parameters
     */
    template<typename ModelType>
    class Configuration : public ClassParameters<ModelType>
    {
    public:
        template<typename SingleClassModel, typename ModelType_> friend class Model;
        ...
        explicit Configuration(Json::Value const& root)
        {
            ...
            multithreading = static_cast<MultithreadingMode>(root.get("multithreading", 0).asInt());
            multiClass_regression_estimator = static_cast<MultiClassRegressionEstimator>(root.get("multiClass_regression_estimator", 0).asInt());
        ...
        /**
         ...
         @details If the parameters have not been edited for this class yet, they are set to the
         default parameters.
        ...
        virtual Json::Value toJson() const
        {
            ...
            root["multiClass_regression_estimator"] = static_cast<int>(multiClass_regression_estimator);
        ...
        /**
         @brief Regression mode for multiple class (prediction from likeliest class vs interpolation)
         */
