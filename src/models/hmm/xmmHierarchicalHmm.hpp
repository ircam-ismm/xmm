...
namespace xmm
{
    /**
     @ingroup HMM
     @brief Hierarchical Hidden Markov Model for Continuous Recognition and Regression (Multi-class)
     */
    ...
    public:
        ...
        //         */
        //        HierarchicalHMM extractSubmodel(std::vector<std::size_t>& columns) const;
        //
        //        /**
