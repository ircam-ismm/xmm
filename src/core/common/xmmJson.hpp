...
namespace xmm
{
    ...
    public:
         ...
         */
        JsonException(JsonErrorType errorType,
                      std::string nodename="") :
    ...
    template <> void json2array(Json::Value const&  root, float* a, std::size_t n);
    template <> void json2array(Json::Value const&  root, double* a, std::size_t n);
    template <> void json2array(Json::Value const&  root, bool* a, std::size_t n);
    template <> void json2array(Json::Value const&  root, std::string* a, std::size_t n);
    ...
    template <> void json2vector(Json::Value const& root, std::vector<float>& a, std::size_t n);
    template <> void json2vector(Json::Value const& root, std::vector<double>& a, std::size_t n);
    template <> void json2vector(Json::Value const& root, std::vector<bool>& a, std::size_t n);
    template <> void json2vector(Json::Value const& root, std::vector<std::string>& a, std::size_t n);
