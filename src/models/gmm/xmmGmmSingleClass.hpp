...
namespace xmm
{
    ...
    public:
         ...
         */
        explicit SingleClassGMM(std::shared_ptr<SharedParameters> p, Json::Value const& root);
    ...
    protected:
        ...
        /**
         ...
         @details computed by combining relative and absolute regularization with the
         training set
         */
