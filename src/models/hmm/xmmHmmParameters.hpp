...
class HMM {
 public:
  ...
  enum class TransitionMode {
    ...
    /**
     @brief Constrained transition matrix
     @details The authorized transitions must be specified in the
     authorizedTransitionss parameter
     */
    Constrained = 2
  };
...
class ClassParameters<HMM> {
 public:
  ...
  /**
   @brief Transition matrix constraints of the model
   */
  Attribute<std::vector<bool>> authorizedPrior;

  /**
   @brief Transition matrix constraints of the model
   */
  Attribute<std::vector<bool>> authorizedTransitions;
