...
class MultimodalHMM : public EMBasedLearningModel< GestureSoundPhrase<ownData> >
{
...
#pragma mark Constructors
    ...
    /*!
     Copy constructor
     */
    MultimodalHMM(MultimodalHMM const& src) : EMBasedLearningModel< GestureSoundPhrase<ownData> >(src)
    {
        _copy(this, src);
    }
