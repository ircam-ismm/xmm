...
#pragma mark === Class Attribute: vector specialization ===
    ...
    public:
        ...
        /**
         ...
         @param value requested value
         @param silently if true, don't notify the listener object
         @throws domain_error exception if the value exceeds the limits, or if the value does not
        ...
        /**
         @brief set the attribute's size (vector Attribute). if 0, there is not size-checking on set.
