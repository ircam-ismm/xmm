...
namespace xmm
{
    /** @ingroup HMM
     ...
     @details Hidden Markov Model with Multivariate Gaussian Mixture Model Observation Distributions.
    ...
    public:
         ...
         */
        explicit SingleClassHMM(std::shared_ptr<SharedParameters> p, Json::Value const& root);
        ...
        //         */
        //        HMM extractSubmodel(std::vector<std::size_t>& columns) const;
        //
        //        /**
