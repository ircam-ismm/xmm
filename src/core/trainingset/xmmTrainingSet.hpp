...
namespace xmm
{
    ...
    public:
        ...
        /**
         ...
         @return true if the training set owns data (construction with MemoryMode::OwnMemory)
         */
        bool ownMemory() const;
        
        /**
         @brief checks if the training set is bimodal
         @return true if the training set is bimodal (construction with Multimodality::Bimodal)
         */
        bool bimodal() const;
        ...
        /**
         @brief add a new phrase, or reset the phrase if existing
         @details The phrase is set to point to the existing phrase passed in argument.
         The phrase is created if it does not exists at the given index.
         @param phraseIndex index of the data phrase in the trainingSet
        ...
        /**
         ...
         @warning in order to protect the phrases in the current training set, the sub-training set returned is locked
