...
namespace xmm
{
    ...
    public:
         ...
         */
        GaussianDistribution(bool bimodal=false,
         ...
         */
        Ellipse toEllipse(std::size_t dimension1,
                          std::size_t dimension2);
        
        /**
         @brief Sets the parameters of the Gaussian distribution according to the 95% Confidence Interval ellipse
         @details the ellipse is 2D, and is therefore projected over 2 axes
         ...
         @throws out_of_range if the dimensions are out of bounds
         */
        void fromEllipse(Ellipse const& gaussian_ellipse_95,
        ...
        //         */
        //        GaussianDistribution extractSubmodel(std::vector<std::size_t>& columns) const;
        //
        //        /**
        ...
        /**
         @brief Conditional Output Variance (updated when covariances matrices are inverted)
         */
    ...
    protected:
        ...
        /**
         @brief Compute the conditional variance vector of the output modality (conditioned over the input).
         @throws runtime_error if the model is not bimodal
         */
    ...
    template <>
    void checkLimits<GaussianDistribution::CovarianceMode>(GaussianDistribution::CovarianceMode const& value,
                                                           GaussianDistribution::CovarianceMode const& limit_min,
                                                           GaussianDistribution::CovarianceMode const& limit_max);
    
    template <>
    GaussianDistribution::CovarianceMode Attribute<GaussianDistribution::CovarianceMode>::defaultLimitMax();
}
