...
xmm::ClassParameters<xmm::HMM>::ClassParameters()
    : changed(true),
      ...
      hierarchical(true),
      authorizedPrior(std::vector<bool>()),
      authorizedTransitions(std::vector<bool>()) {
  states.onAttributeChange(this,
                           &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
  ...
  hierarchical.onAttributeChange(
      this, &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
  authorizedPrior.onAttributeChange(
      this, &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
  authorizedTransitions.onAttributeChange(
      this, &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
}
...
xmm::ClassParameters<xmm::HMM>::ClassParameters(ClassParameters<HMM> const& src)
    : changed(true),
      ...
      authorizedPrior(src.authorizedPrior),
      authorizedTransitions(src.authorizedTransitions) {
  states.onAttributeChange(this,
                           &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
  gaussians.onAttributeChange(
      this, &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
...
xmm::ClassParameters<xmm::HMM>::ClassParameters(Json::Value const& root)
  ...
  // TODO: Read authorizedTransitionss
}
...
Json::Value xmm::ClassParameters<xmm::HMM>::toJson() const {
  ...
  // TODO: Write authorizedTransitionss
  return root;
}
...
xmm::Attribute<xmm::HMM::TransitionMode>::defaultLimitMax() {
  return xmm::HMM::TransitionMode::Constrained;
}
