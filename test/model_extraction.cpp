...
TEST_CASE( "Extract GMM: arbitrary dimensions", "[GMM]" ) {
    ...
    mixtureCoeffs[0] = 3.520518541336e-01;
    mixtureCoeffs[1] = 3.161256909370e-01;
    mixtureCoeffs[2] = 3.318224847317e-01;
    CHECK_VECTOR_APPROX(a.mixtureCoeffs, mixtureCoeffs);
    vector<double> cov_c0(9);
    cov_c0[0] = 1.221632221462e-02;
    cov_c0[1] = 4.046388531643e-03;
    cov_c0[2] = 1.340852812245e-03;
    cov_c0[3] = 4.046388531643e-03;
    cov_c0[4] = 2.579445073380e-03;
    cov_c0[5] = 5.513128128412e-04;
    cov_c0[6] = 1.340852812245e-03;
    cov_c0[7] = 5.513128128412e-04;
    cov_c0[8] = 1.199888844357e-03;
    vector<unsigned int> columns(2);
    columns[0] = 2;
    columns[1] = 0;
    ...
    CHECK(b.dimension_ == 2);
    vector<double> new_covariance(4);
    new_covariance[0] = 1.199888844357e-03;
    new_covariance[1] = 1.340852812245e-03;
    new_covariance[2] = 1.340852812245e-03;
    new_covariance[3] = 1.221632221462e-02;
...
TEST_CASE( "Extract GMM: input & output", "[GMM]" ) {
    ...
    CHECK(b.dimension_ == 2);
    vector<double> new_covariance(4);
    new_covariance[0] = 1.221632221462e-02;
    new_covariance[1] = 4.046388531643e-03;
    new_covariance[2] = 4.046388531643e-03;
    new_covariance[3] = 2.579445073380e-03;
    CHECK_VECTOR_APPROX(b.components[0].covariance, new_covariance);
...
TEST_CASE( "Extract GMM: inverse model", "[GMM]" ) {
    ...
    new_covariance[0] = 1.199888844357e-03;
    new_covariance[1] = 1.340852812245e-03;
    new_covariance[2] = 5.513128128412e-04;
    new_covariance[3] = 1.340852812245e-03;
    new_covariance[4] = 1.221632221462e-02;
    new_covariance[5] = 4.046388531643e-03;
    new_covariance[6] = 5.513128128412e-04;
    new_covariance[7] = 4.046388531643e-03;
    new_covariance[8] = 2.579445073380e-03;
    CHECK_VECTOR_APPROX(b.components[0].covariance, new_covariance);
    CHECK(b.components[0].mean[0] == Approx(a.components[0].mean[2]));
    CHECK(b.components[0].mean[1] == Approx(a.components[0].mean[0]));
...
TEST_CASE( "Extract HMM: arbitrary dimensions", "[HMM]" ) {
    ...
    a.set_nbStates(3);
    a.train();
    vector<float> prior(3);
    prior[0] = 1;
    prior[1] = 0;
    prior[2] = 0;
    CHECK_VECTOR_APPROX(a.prior_, prior);
    vector<float> transition(9);
    transition[0] = 9.710568189621e-01;
    transition[1] = 2.894317544997e-02;
    transition[2] = 0;
    transition[3] = 0;
    transition[4] = 9.693398475647e-01;
    transition[5] = 3.066014684737e-02;
    transition[6] = 0;
    transition[7] = 0;
    transition[8] = 1.;
    CHECK_VECTOR_APPROX(a.transition_, transition);
    ...
    CHECK_VECTOR_APPROX(a.states_[0].components[0].covariance, covariance_state0);
    CHECK_FALSE(a.bimodal_);
    CHECK(a.states_[0].components[0].inverseCovariance_input_.size() == 0);
    vector<unsigned int> columns(2);
    columns[0] = 2;
    columns[1] = 0;
    HMM b = a.extract_submodel(columns);
    CHECK_FALSE(b.bimodal_);
    CHECK(b.states_[0].dimension_ == 2);
    vector<double> new_covariance(4);
    ...
    CHECK_VECTOR_APPROX(b.states_[0].components[0].covariance, new_covariance);
    CHECK_VECTOR_APPROX(b.states_[0].mixtureCoeffs, a.states_[0].mixtureCoeffs);
    CHECK(b.states_[0].components[0].mean[0] == Approx(a.states_[0].components[0].mean[2]));
    CHECK(b.states_[0].components[0].mean[1] == Approx(a.states_[0].components[0].mean[0]));
}
...
TEST_CASE( "Extract HMM: input & output", "[HMM]" ) {
    ...
    CHECK_VECTOR_APPROX(b.states_[0].components[0].covariance, new_covariance);
    CHECK_VECTOR_APPROX(b.states_[0].mixtureCoeffs, a.states_[0].mixtureCoeffs);
    CHECK(b.states_[0].components[0].mean[0] == Approx(a.states_[0].components[0].mean[0]));
    CHECK(b.states_[0].components[0].mean[1] == Approx(a.states_[0].components[0].mean[1]));
    HMM c = a.extract_submodel_output();
    CHECK_FALSE(c.bimodal_);
    CHECK(c.states_[0].dimension_ == 1);
    vector<double> new_covariance_output(1);
    new_covariance_output[0] = 1.131260901171e-03;
    CHECK_VECTOR_APPROX(c.states_[0].components[0].covariance, new_covariance_output);
    CHECK_VECTOR_APPROX(c.states_[0].mixtureCoeffs, a.states_[0].mixtureCoeffs);
    CHECK(c.states_[0].components[0].mean[0] == Approx(a.states_[0].components[0].mean[2]));
}
...
TEST_CASE( "Extract HMM: inverse model", "[HMM]" ) {
    ...
    CHECK(b.states_[0].components[0].mean[0] == Approx(a.states_[0].components[0].mean[2]));
    CHECK(b.states_[0].components[0].mean[1] == Approx(a.states_[0].components[0].mean[0]));
    CHECK(b.states_[0].components[0].mean[2] == Approx(a.states_[0].components[0].mean[1]));
    b.performance_init();
...
TEST_CASE( "Extract HierarchicalHMM: arbitrary dimensions", "[HierarchicalHMM]" ) {
    ...
    prior[1] = 0;
    prior[2] = 0;
    CHECK_VECTOR_APPROX(a.models[label_a].prior_, prior);
    vector<float> transition(9);
    transition[0] = 9.710568189621e-01;
    transition[1] = 2.894317544997e-02;
    transition[2] = 0;
    ...
    transition[7] = 0;
    transition[8] = 1.;
    CHECK_VECTOR_APPROX(a.models[label_a].transition_, transition);
    vector<double> covariance_state0(9);
    covariance_state0[0] = 1.105028519640e-02,
    covariance_state0[1] = 3.397482636225e-03;
    covariance_state0[2] = 1.045622665096e-03;
    ...
    covariance_state0[7] = 3.960464278701e-04;
    covariance_state0[8] = 1.131260901171e-03;
    CHECK_VECTOR_APPROX(a.models[label_a].states_[0].components[0].covariance, covariance_state0);
    CHECK_FALSE(a.bimodal_);
    CHECK(a.models[label_a].states_[0].components[0].inverseCovariance_input_.size() == 0);
    vector<unsigned int> columns(2);
    columns[0] = 2;
    columns[1] = 0;
    HierarchicalHMM b = a.extract_submodel(columns);
    CHECK_FALSE(b.bimodal_);
    CHECK(b.models[label_a].states_[0].dimension_ == 2);
    vector<double> new_covariance(4);
    new_covariance[0] = 1.131260901171e-03;
    new_covariance[1] = 1.045622665096e-03;
    new_covariance[2] = 1.045622665096e-03;
    new_covariance[3] = 1.105028519640e-02;
    CHECK_VECTOR_APPROX(b.models[label_a].states_[0].components[0].covariance, new_covariance);
    CHECK_VECTOR_APPROX(b.models[label_a].states_[0].mixtureCoeffs, a.models[label_a].states_[0].mixtureCoeffs);
    CHECK(b.models[label_a].states_[0].components[0].mean[0] == Approx(a.models[label_a].states_[0].components[0].mean[2]));
    CHECK(b.models[label_a].states_[0].components[0].mean[1] == Approx(a.models[label_a].states_[0].components[0].mean[0]));
}
...
TEST_CASE( "Extract HierarchicalHMM: input & output", "[HierarchicalHMM]" ) {
    ...
    CHECK_VECTOR_APPROX(b.models[label_a].states_[0].components[0].covariance, new_covariance);
    CHECK_VECTOR_APPROX(b.models[label_a].states_[0].mixtureCoeffs, a.models[label_a].states_[0].mixtureCoeffs);
    CHECK(b.models[label_a].states_[0].components[0].mean[0] == Approx(a.models[label_a].states_[0].components[0].mean[0]));
    CHECK(b.models[label_a].states_[0].components[0].mean[1] == Approx(a.models[label_a].states_[0].components[0].mean[1]));
    HierarchicalHMM c = a.extract_submodel_output();
    CHECK_FALSE(c.bimodal_);
    CHECK(c.models[label_a].states_[0].dimension_ == 1);
    vector<double> new_covariance_output(1);
    new_covariance_output[0] = 1.131260901171e-03;
    CHECK_VECTOR_APPROX(c.models[label_a].states_[0].components[0].covariance, new_covariance_output);
    CHECK_VECTOR_APPROX(c.models[label_a].states_[0].mixtureCoeffs, a.models[label_a].states_[0].mixtureCoeffs);
    CHECK(c.models[label_a].states_[0].components[0].mean[0] == Approx(a.models[label_a].states_[0].components[0].mean[2]));
}
...
TEST_CASE( "Extract HierarchicalHMM: inverse model", "[HierarchicalHMM]" ) {
    ...
    CHECK(b.models[label_a].states_[0].components[0].mean[0] == Approx(a.models[label_a].states_[0].components[0].mean[2]));
    CHECK(b.models[label_a].states_[0].components[0].mean[1] == Approx(a.models[label_a].states_[0].components[0].mean[0]));
    CHECK(b.models[label_a].states_[0].components[0].mean[2] == Approx(a.models[label_a].states_[0].components[0].mean[1]));
    b.performance_init();
    observation.resize(1);
    for (unsigned int i=0; i<100; i++) {
        observation[0] = pow(float(i)/100., 3.);
