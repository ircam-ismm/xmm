...
{
    states.onAttributeChange(this, &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
    gaussians.onAttributeChange(this, &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
    relative_regularization.onAttributeChange(this, &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
    absolute_regularization.onAttributeChange(this, &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
    covariance_mode.onAttributeChange(this, &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
    transition_mode.onAttributeChange(this, &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
    regression_estimator.onAttributeChange(this, &xmm::ClassParameters<xmm::HMM>::onAttributeChange);
}
...
ClassParameters()
{
    ...
    transition_mode.set(static_cast<HMM::TransitionMode>(root["transition_mode"].asInt()));
    regression_estimator.set(static_cast<HMM::RegressionEstimator>(root["regression_estimator"].asInt()));
}

xmm::ClassParameters<xmm::HMM>& xmm::ClassParameters<xmm::HMM>::operator=(ClassParameters<HMM> const& src)
{
    if(this != &src)
    {
        changed = true;
...
void xmm::ClassParameters<xmm::HMM>::onAttributeChange(AttributeBase* attr_pointer)
{
    changed = true;
...
template <>
void xmm::checkLimits<xmm::HMM::TransitionMode>(xmm::HMM::TransitionMode const& value,
...
template <>
void xmm::checkLimits<xmm::HMM::RegressionEstimator>(xmm::HMM::RegressionEstimator const& value,
