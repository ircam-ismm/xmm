...
TEST_CASE( "Convert GMM: unimodal->bimodal", "[GMM]" ) {
    ...
    invcov_c0_input[0] = 170.39455705;
    invcov_c0_input[1] = -267.29880338;
    invcov_c0_input[2] = -267.29880338;
    invcov_c0_input[3] = 806.99326921;
...
TEST_CASE( "Convert HMM: unimodal->bimodal", "[HMM]" ) {
    ...
    b.make_bimodal(2);
    CHECK(b.bimodal_);
    CHECK(a.prior_ == b.prior_);
    CHECK(a.transition_ == b.transition_);
    for (unsigned int i=0; i<a.get_nbStates(); i++) {
        CHECK(a.states_[i].components[0].mean == b.states_[i].components[0].mean);
        CHECK(a.states_[i].components[0].covariance == b.states_[i].components[0].covariance);
        CHECK(a.states_[i].components[0].inverseCovariance_ == b.states_[i].components[0].inverseCovariance_);
        CHECK(a.states_[i].components[0].inverseCovariance_input_.size() == 0);
        CHECK(b.states_[i].components[0].inverseCovariance_input_.size() == 4);
    }
    ...
    CHECK_VECTOR_APPROX(b.states_[0].components[0].inverseCovariance_input_, invcov_state0_input);
}
...
TEST_CASE( "Convert HMM: bimodal->unimodal", "[HMM]" ) {
    ...
    invcov_state0_input[2] = -258.98593022;
    invcov_state0_input[3] = 842.34967393;
    CHECK_VECTOR_APPROX(a.states_[0].components[0].inverseCovariance_input_, invcov_state0_input);
    CHECK(a.bimodal_);
    CHECK(a.states_[0].components[0].inverseCovariance_input_.size() == 4);
    HMM b(a);
    CHECK_THROWS(b.make_bimodal(2););
    CHECK_NOTHROW(b.make_unimodal());
    CHECK_FALSE(b.bimodal_);
    ...
    for (unsigned int i=0; i<a.get_nbStates(); i++) {
        ...
        CHECK(a.states_[i].components[0].covariance == b.states_[i].components[0].covariance);
        CHECK(a.states_[i].components[0].inverseCovariance_ == b.states_[i].components[0].inverseCovariance_);
        CHECK(a.states_[i].components[0].inverseCovariance_input_.size() == 4);
        CHECK(b.states_[i].components[0].inverseCovariance_input_.size() == 0);
    }
}
...
TEST_CASE( "Convert HierarchicalHMM: unimodal->bimodal", "[HierarchicalHMM]" ) {
    ...
    b.make_bimodal(2);
    CHECK(b.bimodal_);
    CHECK(a.models[label_a].prior_ == b.models[label_a].prior_);
    CHECK(a.models[label_a].transition_ == b.models[label_a].transition_);
    for (unsigned int i=0; i<a.get_nbStates(); i++) {
        CHECK(a.models[label_a].states_[i].components[0].mean == b.models[label_a].states_[i].components[0].mean);
        CHECK(a.models[label_a].states_[i].components[0].covariance == b.models[label_a].states_[i].components[0].covariance);
        CHECK(a.models[label_a].states_[i].components[0].inverseCovariance_ == b.models[label_a].states_[i].components[0].inverseCovariance_);
        CHECK(a.models[label_a].states_[i].components[0].inverseCovariance_input_.size() == 0);
        CHECK(b.models[label_a].states_[i].components[0].inverseCovariance_input_.size() == 4);
    }
    vector<double> invcov_state0_input(4);
    invcov_state0_input[0] = 170.12232422;
    invcov_state0_input[1] = -258.98593022;
    invcov_state0_input[2] = -258.98593022;
    invcov_state0_input[3] = 842.34967393;
    CHECK_VECTOR_APPROX(b.models[label_a].states_[0].components[0].inverseCovariance_input_, invcov_state0_input);
}
...
TEST_CASE( "Convert HierarchicalHMM: bimodal->unimodal", "[HierarchicalHMM]" ) {
    ...
    invcov_state0_input[2] = -258.98593022;
    invcov_state0_input[3] = 842.34967393;
    CHECK_VECTOR_APPROX(a.models[label_a].states_[0].components[0].inverseCovariance_input_, invcov_state0_input);
    CHECK(a.bimodal_);
    CHECK(a.models[label_a].states_[0].components[0].inverseCovariance_input_.size() == 4);
    HierarchicalHMM b(a);
    CHECK_THROWS(b.make_bimodal(2););
    CHECK_NOTHROW(b.make_unimodal());
    CHECK_FALSE(b.bimodal_);
    CHECK(a.models[label_a].prior_ == b.models[label_a].prior_);
    CHECK(a.models[label_a].transition_ == b.models[label_a].transition_);
    CHECK(a.models[label_b].prior_ == b.models[label_b].prior_);
    CHECK(a.models[label_b].transition_ == b.models[label_b].transition_);
    for (unsigned int i=0; i<a.get_nbStates(); i++) {
        CHECK(a.models[label_a].states_[i].components[0].mean == b.models[label_a].states_[i].components[0].mean);
        CHECK(a.models[label_a].states_[i].components[0].covariance == b.models[label_a].states_[i].components[0].covariance);
        CHECK(a.models[label_a].states_[i].components[0].inverseCovariance_ == b.models[label_a].states_[i].components[0].inverseCovariance_);
        CHECK(a.models[label_a].states_[i].components[0].inverseCovariance_input_.size() == 4);
        CHECK(b.models[label_a].states_[i].components[0].inverseCovariance_input_.size() == 0);
    }
}
